...
export const ENEMY_SIZE = { chaser: 14, patroller: 18, hulk: 22 };
export const ENEMY_COUNT = 20;
export const ENEMY_SPAWN_INTERVAL = 1; // seconds between spawns
export const ENEMY_SPEED = { chaser: 160, patroller: 100, hulk: 70 };
export const ENEMY_DAMAGE = { chaser: 1, patroller: 2, hulk: 3 };
